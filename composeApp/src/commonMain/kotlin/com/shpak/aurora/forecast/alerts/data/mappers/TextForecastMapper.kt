package com.shpak.aurora.forecast.alerts.data.mappers
...
fun String.toGeomagneticForecast(): GeomagneticForecast {
    ...
    return GeomagneticForecast(
        retrieveMaxKp(),
        forecastList.map { gmd -> GeomagneticData(gmd.date.toLocalTime(), gmd.kpValue) }
            .sortedWith { gmd1, gmd2 -> gmd1.date.compareTo(gmd2.date) }
    )
}
 */
